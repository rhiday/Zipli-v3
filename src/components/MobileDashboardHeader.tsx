      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-4">
          <Button
            variant="secondary"
            size="sm"
            className="rounded-full border border-white/50 bg-white/10 hover:bg-white/20 text-white !text-label"
          >
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="rounded-full border border-white/50 bg-white/10 hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary focus:ring-white"
            >
              <Avatar
        ...
        <p className="text-body font-semibold text-primary-25/80 mb-1">
          {t('goodToSeeYou')}
        </p>
