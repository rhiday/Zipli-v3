...
const Skeleton: React.FC<SkeletonProps> = React.memo(
  ({ className, variant = 'pulse', children }) => {
    ...
    return (
      <div
        className={cn('bg-gray-200 rounded-md', animationClass, className)}
        aria-hidden="true"
      >
        {children}
      </div>
...
export const SkeletonCard: React.FC<{ className?: string }> = React.memo(
  ({ className }) => (
...
export const SkeletonDashboardStat: React.FC<{ className?: string }> =
...
export const SkeletonRecipient: React.FC<{ className?: string }> = React.memo(
  ({ className }) => (
...
export const SkeletonButton: React.FC<{ className?: string }> = React.memo(
  ({ className }) => (
