...
import { getAllergenKeyword } from '@/constants/allergens';
...
export const SummaryCard: React.FC<SummaryCardProps> = ({
  ...
  return (
    <div className={cn('space-y-4', className)}>
      {title && (
        <h2 className="text-lg font-semibold text-[#021d13]">{title}</h2>
      )}
...
export const AllergenChips: React.FC<AllergenChipsProps> = ({
  ...
  return (
    <div
      className={cn(
        'flex flex-wrap gap-1 justify-end max-w-[200px]',
        className
      )}
    >
