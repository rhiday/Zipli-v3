  ...
  return (
    <div className="min-h-dvh flex items-center justify-center bg-cream p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-6 flex flex-col items-center">
        <h1 className="text-titleMd font-bold text-primary mb-3 text-center">
          Confirm Handover
        </h1>
        ...
        <div className="mb-6">
          <span className="font-semibold text-primary block text-center text-base">
            Before handing over the donation, please make sure that the
            temperature is <span className="text-green-700">above 60°C</span>{' '}
            for warm food donation or{' '}
            <span className="text-blue-700">under 6°C</span> for cold food
            donation.
          </span>
        </div>
        {error && (
          <div className="text-negative bg-rose-100 rounded p-2 text-sm mb-4 w-full text-center">
            {error}
          </div>
        )}
