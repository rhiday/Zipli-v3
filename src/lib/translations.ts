...
export const translations = {
  en: {
    ...
    donationUpdated: 'Listing updated successfully!',
    donationUpdateDescription: 'Your donation has been successfully updated.',
    changesHaveBeenSaved: 'Your changes have been saved successfully.',
    matchingContinues: 'Matching continues',
    ...
    environmentalAndSocialImpactData:
      'Click above to access more data for reporting and operation planning.',
    error: 'Error',
    errorDetails: 'Error details (development only)',
    explore: 'Explore',
    exploreAvailableDonations: 'Explore available listings',
    exportToPdf: 'More impact data',
    ...
    pleaseSelectAllergens: 'Please select allergens',
    portions: 'portions',
    ...
    totalFoodOffered: 'Amount of food on the listing day',
    ...
    yourImpact:
      'Your actions are making a difference! The impact of your latest activities:',
    // Recurrence scheduler translations
    ...
    donationUpdated: 'Ilmoitus päivitetty onnistuneesti!',
    donationUpdateDescription: 'Lahjoituksesi on päivitetty onnistuneesti.',
    changesHaveBeenSaved: 'Muutoksesi on tallennettu onnistuneesti.',
    matchingContinues: 'Vastaavuus jatkuu',
    ...
    environmentalAndSocialImpactData:
      'Siirry tarkastelemaan dataa luomastasi vaikuttavuudesta raportointia ja toiminnan suunnittelua varten.',
    error: 'Virhe',
    errorDetails: 'Virheen tiedot (vain kehityksessä)',
    explore: 'Tutki',
    exploreAvailableDonations: 'Tutki aktiivisia ilmoituksia',
    exportToPdf: 'Lisää vaikuttavuusdataa',
    ...
    pleaseSelectAllergens: 'Valitse allergeenit',
    portions: 'annosta',
    ...
    totalFoodOffered: 'Ruuan määrä ilmoituspäivänä',
    ...
    yourImpact:
      'Teoillasi on aitoa merkitystä! Viimeisimpien aktiviteettiesi vaikutus:',
    // Recurrence scheduler translations
