...
export const en = {
  ...
  totalValueOfFoodSold: 'Total value of food sold',
  totalKgDistributed: 'Total kg of food distributed',
  organizationsReached: 'Organizations Reached',
  wasteReduction: 'Waste Reduction',
  fromLastMonth: 'from last month',
  newThisMonth: 'new this month',
  wasteReductionTarget: 'Target: reduce food waste by 30% until 2030',
  currentWaste: 'Current waste',
  targetWaste: 'Target',
  upcoming: 'Upcoming',
