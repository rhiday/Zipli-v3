...
export const fi = {
  ...
  totalValueOfFoodSold: 'Ruoan myyntiarvo yhteensä',
  totalKgDistributed: 'Jaetun ruoan määrä yhteensä (kg)',
  organizationsReached: 'Tavoitetut organisaatiot',
  wasteReduction: 'Hävikkivähennys',
  fromLastMonth: 'edellisestä kuukaudesta',
  newThisMonth: 'uutta tässä kuukaudessa',
  wasteReductionTarget: 'Tavoite: vähennä ruokahävikkiä 30% vuoteen 2030 mennessä',
  currentWaste: 'Nykyinen hävikki',
  targetWaste: 'Tavoite',
  upcoming: 'Tulevat',
