...
describe('Skeleton Components', () => {
  ...
  describe('SkeletonCard', () => {
    it('renders card skeleton structure', () => {
      ...
      expect(
        container.querySelector('.aspect-\\[4\\/3\\]')
      ).toBeInTheDocument();
  ...
  describe('SkeletonDashboardStat', () => {
    ...
    it('applies custom className', () => {
      const { container } = render(
        <SkeletonDashboardStat className="custom-stat" />
      );
  ...
  describe('SkeletonRecipient', () => {
    ...
    it('applies custom className', () => {
      const { container } = render(
        <SkeletonRecipient className="custom-recipient" />
      );
  ...
  describe('SkeletonText', () => {
    ...
    it('applies custom className to lines', () => {
      const { container } = render(
        <SkeletonText lineClassName="custom-line" />
      );
